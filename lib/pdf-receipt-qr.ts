// Secure PDF receipt generator with QR code verification
...
export class SecureQRReceiptGenerator {
...
<body>
    <div class="receipt-container">
        ...
        <footer class="footer">
            ...
            <div class="security-note">This receipt contains security features to prevent forgery. QR code and verification code: ${receiptHash}</div>
        </footer>
    </div>
</body>
</html>`
